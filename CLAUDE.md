...
- One manager account exists: `manager@fleet-inspect.app` (password given to the user in chat when created 2026-07-30, not stored in this repo). Create more accounts via the Firebase Console → Authentication, or `POST https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=<API_KEY>`.
